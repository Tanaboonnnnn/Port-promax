export const latestScan = {
  ...
  th: {
    ...
    holdingUpdates: {
      ...
      USD: {
        thesis:
          "เงินสดยังเป็นตำแหน่งที่ตั้งใจถือ ไม่ใช่ช่องว่างในพอร์ต อัปเดตเรื่องน้ำและทรัพยากรของ Microsoft หนุนหุ้นที่ถืออยู่แล้ว แต่ยังไม่ใช่ trigger ให้ใช้เงินสดเพิ่ม Visa Destinations ก็เป็นบวกเชิงกลยุทธ์แต่ยังพิสูจน์ economics ไม่พอ รอบนี้ยังไม่มีหลักฐานใหม่ที่ทำให้ AutoZone หรือ Copart ชนะทั้งหุ้นเดิมและความยืดหยุ่นของเงินสดได้ชัดพอ.",
      },
    },
    decision: {
      date: "2026-06-26 10:30 ET",
