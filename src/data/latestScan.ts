export const latestScan = {
  en: {
    ...
    holdingUpdates: {
      MSFT: {
        ...
        assumptions: [
          ...
          "Partner incentives and promotions must eventually show paid adoption, customer outcomes, renewal quality, margins, and per-share returns.",
        ],
      },
      V: {
        weight: 22.23,
    ...
    watchlistUpdates: {
      AZO: {
        whyNotYet:
          "AutoZone remains watchlist / do nothing. The July 7 S-3ASR and preliminary 424B5 make the capital-structure monitor concrete, but final note pricing, size, use of proceeds, leverage impact, buyback funding, and sustained operating proof are still needed before AZO can beat cash or the current funded holdings.",
      },
      CPRT: {
        whyNotYet:
    ...
    nextFocus: [
      "Track whether Microsoft's CSP growth margins, Copilot, Agent 365, Windows 365, and partner-channel promotions translate into paid attach, seat expansion, customer outcomes, renewal quality, margin contribution, and per-share AI returns.",
      ...
      "Review Copart's official July 6 call audio or a complete transcript, then judge whether Jay Adair's priorities protect execution, culture, customer relationships, growth quality, and capital allocation.",
  ...
  th: {
    ...
    holdingUpdates: {
      MSFT: {
        ...
        assumptions: [
          ...
          "แรงจูงใจและโปรของพาร์ตเนอร์ต้องค่อย ๆ พิสูจน์ paid adoption, customer outcomes, renewal quality, margin และผลตอบแทนต่อหุ้น.",
        ],
      },
      V: {
        weight: 22.23,
    ...
    watchlistUpdates: {
      AZO: {
        whyNotYet:
          "AutoZone ยังเป็น watchlist / do nothing. S-3ASR และ preliminary 424B5 วันที่ 7 ก.ค. ทำให้ monitor ด้าน capital structure ชัดขึ้น แต่ยังต้องรอ pricing, size, use of proceeds, leverage impact, การหนุน buyback และ operating proof ต่อเนื่องก่อน AZO จะชนะเงินสดหรือหุ้นที่ถืออยู่.",
      },
      CPRT: {
        whyNotYet:
    ...
    nextFocus: [
      "ตามว่า CSP growth margins, Copilot, Agent 365, Windows 365 และโปรของพาร์ตเนอร์ช่วยให้ Microsoft มี paid attach, seat expansion, customer outcomes, renewal quality, margin contribution และผลตอบแทนต่อหุ้นจาก AI จริงหรือไม่.",
      ...
      "ฟัง replay ทางการหรืออ่าน transcript เต็มของ Copart call วันที่ 6 ก.ค. แล้วดูว่า Jay Adair พูดเรื่อง execution, culture, customer relationships, growth quality และ capital allocation ชัดพอหรือไม่.",
