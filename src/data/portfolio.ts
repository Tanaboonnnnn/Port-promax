...
export const benchmarkPoints: BenchmarkPoint[] = [
  {
    ...
    smh: null,
    vt: null,
    note: "Inception baseline. Partial-week QQQ, SMH, and VT fields remain explicit fallback states.",
  },
  {
    label: "May 18",
    portfolio: 0.19,
    ...
    smh: 3.59,
    vt: null,
    note: "Backfilled weekly row; some benchmark fields still need clean source confirmation in app data.",
  },
  {
    label: "May 25",
    portfolio: 1.62,
