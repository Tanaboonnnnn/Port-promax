...
export const portfolioSnapshot = {
  ...
  asOf: "2026-06-17 14:30 ET scan; NAV last verified 2026-06-12 close",
  ...
  outcomeQuality: "Latest verified mark remains the week ended 2026-06-12. The 14:30 ET checkpoint found no exposure-changing evidence; the official Fed hold was treated as market context only.",
};
...
export const watchlist: WatchlistItem[] = [
  {
    ...
    whyNotYet:
      "Fiscal Q3 repaired some weakness and the new authorization is constructive, but no new 14:30 ET evidence makes AutoZone outrank cash or the current funded holdings without more durable operating evidence and valuation support.",
  },
  {
    company: "Copart",
    ticker: "CPRT",
...
export const quarterlyStatus = [
  ...
  },
  {
    ...
    value: "None. Microsoft, Visa, S&P Global, Alphabet, and cash remain unchanged after the 2026-06-17 14:30 ET scan.",
  },
  {
...
export const nextFocus = [
  ...
  "Treat the official Fed hold at 3.50%-3.75% as market context only unless it reveals company-specific business-quality evidence.",
];